...
mod tests {
    ...
    #[tokio::test]
    #[ignore = "Requires live Medplum server at 100.119.83.76:8103"]
    async fn test_medplum_server_connection() {
        let client = MedplumClient::new(
            "http://100.119.83.76:8103",
        ...
        let response = reqwest::get("http://100.119.83.76:8103/.well-known/openid-configuration")
            .await
    ...
    async fn test_medplum_fhir_metadata() {
        let response = reqwest::get("http://100.119.83.76:8103/fhir/R4/metadata")
            .await
