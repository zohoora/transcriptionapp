...
export function createStandardMock(overrides: Record<string, unknown> = {}) {
  return (command: string) => {
    const responses: Record<string, unknown> = {
      ...
      get_room_config: { room_name: 'Test Room', profile_server_url: 'http://localhost:8090' },
      get_physicians: [],
      get_active_physician: { id: 'doc-1', name: 'Dr. Test', specialty: null, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
