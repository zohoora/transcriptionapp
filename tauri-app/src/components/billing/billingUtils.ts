...
export const OHIP_CODE_CRITERIA: Record<string, string> = {
  ...
  G369A: 'BCG Inoculation: B.C.G. inoculation following tuberculin test',
  G370A: 'Joint/Bursa Injection: Injection or aspiration of joint, bursa, ganglion, or tendon sheath (first site)',
  G371A: 'Additional Joint/Bursa (add-on to G370): Each additional joint, bursa, ganglion, or tendon sheath (max 3)',
  G372A: 'Additional IM/SC Injection: Each additional IM, SC, or intradermal injection when given with a visit',
  G384A: 'Trigger Point Injection: Infiltration of tissue at trigger point site',
  G385A: 'Trigger Point Additional: Each additional trigger point site (max 2, add-on to G384)',
  G228A: 'Paravertebral Nerve Block: Single code covers all spinal levels — cervical, thoracic, lumbar, sacral, coccygeal. The GP-billable alternative to specialist epidural codes',
  G231A: 'Somatic/Peripheral Nerve Block: Block of one peripheral nerve or site',
...
const EXCLUSION_GROUPS: ExclusionGroup[] = [
  ...
  { name: 'Trigger point sites', codes: ['G384A', 'G385A'], reason: 'G384 is first site, G385 is add-on — don\'t bill both as standalone' },
