...
interface MedicationsBlockProps {
  med: UseMedicationAssessmentResult;
}

export const MedicationsBlock = memo(function MedicationsBlock({ med }: MedicationsBlockProps) {
  return (
    <section className="ca-sidebar-section ca-meds-block">
      <h2>Medications</h2>
