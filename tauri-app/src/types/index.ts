...
/**
 * Mirror of the Rust `OrtHealth` enum (serde tag="state", snake_case).
 */
export type OrtHealthStatus =
  | { state: 'ok'; dylib_path: string }
  | { state: 'missing' }
  | { state: 'load_failed'; dylib_path: string; error: string };
