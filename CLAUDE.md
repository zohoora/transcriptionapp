...
├── docs/                   # Historical review docs and ADRs
│   ├── adr/                # Architecture Decision Records (0001-0020)
│   └── *.md                # Historical code review documents
...
# Tests
cd tauri-app && pnpm test:run             # Frontend (Vitest, 387 tests)
cd tauri-app/src-tauri && cargo test      # Backend (421 tests)
